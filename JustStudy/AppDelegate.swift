...
class AppDelegate: UIResponder, UIApplicationDelegate/*, GIDSignInDelegate*/ {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //設定NavigationBar顏色
        UINavigationBar.appearance().barTintColor = UIColor(red:0.09, green:0.16, blue:0.49, alpha:1.0)
        UINavigationBar.appearance().tintColor = UIColor.white
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName: UIColor.white]
        //設定TabBar顏色
        UITabBar.appearance().tintColor = UIColor.white
        //UIColor(red:0.26, green:0.52, blue:0.96, alpha:1.0)
        UITabBar.appearance().barTintColor = UIColor(red:0.09, green:0.16, blue:0.49, alpha:1.0)
        //UIColor(red:0.26, green:0.52, blue:0.96, alpha:1.0)
