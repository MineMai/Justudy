    ...
    [
        [
            ["id":"1",
             ...
             "scholl_detail":"ILSC的托福課程，目標在把學生的托福iBT成績提升到能進入當地大學的入學水平，並順利進入當地大專院校就讀。由於ILSC的多倫多與溫哥華校區本身是托福官方授權的考試中心，學生可以在學校考照，占有熟悉環境的優勢。",
             "image":"ILSC_Van",
             "lat":49.283776,
             "log":-123.113901],
            ["id":"2",
             ...
             "scholl_detail":"Embassy 語言中心舊金山校區這裏以餐廳、商店、電影院和地方娛樂表演聞名。從 學校到旅館和學生公寓走路就會到，且靠近所有的大眾運輸工具。我們舊金山校區最多可容納180位學生。 有12間設備完善的教室",
             "image":"Embassy",
             "lat":37.795442,
             "log":-122.402768]
        ],
        [
            ["id":"1",
             ...
             "scholl_detail":"從1960年成立的Blanche Macdonald Centre是加拿大規模最大的流行專業學院。 學校提供專業培訓課程，包括: 時尚行銷採購文憑課程，時尚設計文憑課程，專業彩妝師文憑課程",
             "image":"Blanche",
             "lat":49.283776,
             "log":-123.113901],
            ["id":"2",
             ...
             "scholl_detail":"劍橋視覺及表演藝術學校Cambridge School Of Visual & Performing ARTS (CSVPA) 所提供的大學預修課程，以獨特學習的創造性，讓對藝術及設計有興趣的學子們，充分發揮其自己的潛力及天份",
             "image":"CVSPA",
             "lat":52.208923,
             "log":0.118872],
        ],
        [
            ["id":"1",
             ...
             "scholl_detail":"藍帶選擇日本開設分校的優勢是考量日本是亞洲西餐與西點文化的領軍者，這裡聚集眾多的米其林星級餐廳、高級甜品店與烘焙坊，相對的日本餐飲競爭度也強，可以給學生比較正面的刺激。",
             "image":"BHMS",
             "lat":35.710294,
             "log":139.810726],
            ["id":"2",
             ...
             "scholl_detail":"BHMS瑞士工商飯店管理學院（BHMS International AG, Business & Hotel Management School）坐落於瑞士著名的旅遊勝地盧塞恩市(Luzern)，隸屬於瑞士歷史悠久的Benedict教育集團",
             "image":"George",
             "lat":47.053638,
             "log":8.294087],
        ]
